...
fake_student_df <- data.frame(
  ...
  last_name = sample(c("Doe", "Smith", "Johnson", "Williams", "Dal'y", NA), sample_size, replace = TRUE),
  first_name = sample(c("Jane", "Joe", "Robert", "Mary", ".abcdefghijklmnop", NA), sample_size, replace = TRUE),
  middle_name = sample(c("Elizabeth", "Louise", "Ann", "Lee", "Peggy-sue", NA), sample_size, replace = TRUE),
  name_suffix = sample(c("Jr.", "Sr.", "I", "II", "III", NA), sample_size, replace = TRUE),
  previous_last_name = sample(c("Doe", "Smith", "Johnson", "Williams", "Marry Ann", NA), sample_size, replace = TRUE),
  previous_first_name = sample(c("Jane", "Joe", "Robert", "Mary", "Iron Man", NA), sample_size, replace = TRUE),
  previous_middle_name = sample(c("Elizabeth", "Louise", "Ann", "Lee", "CraigAlanDemke12", NA), sample_size, replace = TRUE),
  previous_name_suffix = sample(c("Jr.", "Sr.", "I", "II", "III", "12345", NA), sample_size, replace = TRUE),
