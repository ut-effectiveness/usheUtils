...
change_s_17_registration_status_df <- s_17_registration_status_test_df %>%
   mutate(s_reg_status = case_when(
      ...
      student_type_code == "F" ~ 'FF', # TODO  make a if_else statement Freshman > than 1 year of hs grad
      student_type_code == "F" ~ 'FH', # TODO New Freshman from HS -- based on grad date within 1 year of hs grad
