...
```{r}
DT::datatable(format_s_45_bia_flag(s_45_bia_flag_test_df), rownames=FALSE)
```

s_45_bia_flag_real_df for the real data
```{r}
DT::datatable(format_s_45_bia_flag(s_45_bia_flag_real_df,with_intermediates=TRUE), rownames=FALSE)
```
