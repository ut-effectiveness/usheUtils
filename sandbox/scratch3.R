...
#' @export
#'
generate_missionary_submission_file <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' Calculate USHE Element m_04 (Student ID Flag)
#'
#' @details
#'
#' **USHE Documentation**
...
#' m_04()
#'
m_04 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {

  output_df <- input_df %>%
    # Calculate intermediate fields
    mutate( m_end_date = term_end_date ) %>%
