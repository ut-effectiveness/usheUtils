...
#' r_03()
#'
r_03 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' @importFrom dplyr select
#'
#' @param input_df A Data Frame. Must contain the following data fields: (room_id).
#' @param with_intermediates Boolean: Option to include intermediate calculated fields.
#'
#' @return Original data frame, with USHE data element r_03 appended. Will also return appended intermediate calculated fields, if option is set.
#' @export
...
#' r_04()
#'
r_04 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {

  output_df <- input_df %>%
    # Calculate intermediate fields
    mutate( r_number = room_id ) %>%
...
#' r_05()
#'
r_05 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_06()
#'
r_06 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_07()
#'
r_07 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_08()
#'
r_08 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_09()
#'
r_09 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_10()
#'
r_10 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_11()
#'
r_11 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_12()
#'
r_12 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_13()
#'
r_13 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_14()
#'
r_14 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
...
#' r_15()
#'
r_15 <- function(input_df=usheUtils::fake_student_df, with_intermediates=FALSE) {
