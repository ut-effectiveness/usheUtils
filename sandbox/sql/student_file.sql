...
SELECT c.season,
       ...
       -- latest_high_school_code, latest_high_school_desc,
       -- student_term_level house_bill_75_waiver,
       a.secondary_major_cip_code,
       -- a.transfer_cumulative_clep_earned,
       -- a.transfer_cumulative_ap_credits_earned,
